...
(
    ...
    constraint CK_Type_in_Insurance check (Type IN ('ОСАГО', 'КАСКО')),
...
values ('Анохина', 'Ирина', 'Прокопьевна', '1989-02-22', 'Сергиев Посад, Зеленый пер., д. 20, кв. 58',
       ...
       ('Иванов', 'Петр', 'Сергеевич', '1990-05-15', 'Стерлитамак, ул. Пушкина, д.10, кв. 5, Москва',
        '9998887766', '1234567890', 'B', '2010-08-20', '99'),
       ('Павлова', 'Оксана', 'Анатольевна', '1989-06-14', 'Иркутск, пр. Октября, д.3, кв. 18, Москва',
        '9998887555', '3333333333', 'B', '2014-02-14', '1010'),
       ('Дмитриев', 'Дмитрий', 'Дмитриевич', '1955-08-08', 'Уфа, ул. Чайковского 45д.10, кв.55, Москва',
        '8901234567', '5058664913', 'B', '1980-03-01', '1111'),
       ('Иванова', 'Надежда', 'Ивановна', '1990-01-01', 'Уфа, ул. Пушкина д.10, кв.5, Москва', '9841778691',
        '5186966527', 'B', '2010-01-01', '1212'),
       ('Петров', 'Алексей', 'Иванович', '1985-10-25', 'Уфа, пр. Ленина, д.5, кв. 8, Санкт-Петербург',
        '9998887755', '4630893826', 'B', '2007-12-15', '1313'),
       ('Кузнецов', 'Антон', 'Игоревич', '1993-11-05',
        'Уфа, ул. Советская, д.15, кв. 55, Санкт-Петербург', '9998887444', '8274826679', 'B', '2015-10-01',
        '1414');
go
...
values (1, 'ОСАГО', 'XXX2327722810', '2023-07-08', 1),
       (4, 'ОСАГО', 'CCC5691229946', '2023-05-18', 2),
       (2, 'ОСАГО', 'TTT9623766948', '2023-06-18', 3),
       (1, 'ОСАГО', 'PPP9749453459', '2023-04-11', 4),
       (3, 'ОСАГО', 'HHH2131648056', '2023-04-04', 5),
       (1, 'ОСАГО', 'MMM1295173783', '2023-09-22', 6),
       (4, 'ОСАГО', 'KKK1559591916', '2023-06-02', 7),
       (2, 'ОСАГО', 'EEE1976879457', '2023-04-12', 8),
       (2, 'ОСАГО', 'BBB1601194846', '2023-08-24', 9)
go

insert into Insurance (Insurance_company_id, Type, Insurance, Date_of_issue, Vehicle_id)
values (2, 'КАСКО', 'AAM5525818582', '2023-06-18', 3),
       (3, 'КАСКО', 'AAK8965966908', '2023-04-04', 5),
       (2, 'КАСКО', 'AAB3607608593', '2023-04-12', 8)
go
...
VALUES (1, 1, 1, 0, 0, NULL, 0, NULL, NULL, 1, NULL, 1),
       (2, 2, 2, 0, 0, 'Бампер передний', 0, NULL, NULL, 0, 'Санкт-Петербург, ул. Подольских Курсантов, вл. 7а', 0),
       (3, 3, 3, 1, 1, 'Крыло переднее левое', 0, NULL, NULL, 1, NULL, 1),
       ...
       (2, 12, 3, 0, 1, 'Бампер задний', 0, NULL, NULL, 0, 'Санкт-Петербург, Открытое шоссе, вл. 14Г, стр. 1', 0),
       (3, 13, 4, 1, 0, 'Крыло заднее левое', 1, 'Витрина', 'ООО «Фрукты и овощи»', 1, NULL, 1),
...
------------------------------------------ ФУНКЦИИ ------------------------------------------
-- 1. Функция, которая считает количество пострадавших и погибших.
...
-- 3. Функция возврат таблицы: все люди, которые были в ДТП определённого типа.
...
go
-- select *
-- from dbo.GetRtaDetailsByType('Обгонял')
...
select RTA.RTA_id,
       ...
       'by_an_GIBDD_officer' = (CASE by_an_GIBDD_officer WHEN 1 THEN 'Да' WHEN 0 THEN 'Нет' END),
